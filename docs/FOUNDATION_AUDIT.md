...
| Raster | Full-page layers, parameterized brush/eraser/fill/gradient/shape primitives, masks, alpha lock, split latest stroke, tones/effect lines and replayable Blur/Sharpen/Dodge/Burn/Sponge/Red Eye brushes | Several named presets intentionally share a tested raster primitive; vector editing, healing/clone/content-aware retouch and frequency separation are not emulated |
