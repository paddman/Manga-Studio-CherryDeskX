...
| Lettering | Horizontal/vertical text, font/weight/alignment/spacing/outline/shadow, auto-fit, reusable style presets, six balloon variants, multiple tails and basic Japanese kinsoku wrapping shared by auto-fit/export | Font upload/embedding, full JIS X 4051 line composition, text-on-path and text warp remain follow-up work |
